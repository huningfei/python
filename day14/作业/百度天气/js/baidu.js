  ...
  $(function () {
                ...
                $.ajax({
                    url:'https://free-api.heweather.com/s6/air/now?location=beijing&key=7e2f47ead8a94ecab4b9e04f1f8d4a3f',
                    type:'get',
                    success:function (data){

                        $('.show-air .show-polution-name').text(data.HeWeather6[0].air_now_city.qlty);
                        $('.show-air .show-polution-num').text(data.HeWeather6[0].air_now_city.pm25);
                    }
